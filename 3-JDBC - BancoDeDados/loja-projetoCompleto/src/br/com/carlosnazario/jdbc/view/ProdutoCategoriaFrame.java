package br.com.carlosnazario.jdbc.view;
...
import br.com.carlosnazario.jdbc.controller.CategoriaController;
import br.com.carlosnazario.jdbc.controller.ProdutoController;
import br.com.carlosnazario.jdbc.modelo.Categoria;
import br.com.carlosnazario.jdbc.modelo.Produto;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	private void alterar() {
		Object objetoDaLinha = (Object) modelo
				.getValueAt(tabela
				.getSelectedRow(), tabela
				.getSelectedColumn());
